...
})({"45rJe":[function(require,module,exports) {
"use strict";
...
module.bundle.HMR_BUNDLE_ID = "f1e3f7c6d00e456f";
...
},{}],"9gSo8":[function(require,module,exports) {
...
document.getElementById("player_question").innerText = `Question Turn -  ${player1_name.toLowerCase().charAt(0).toUpperCase() + player1_name.slice(1)}`;
document.getElementById("player_answer").innerHTML = `Answer Turn - ${player2_name.toLowerCase().charAt(0).toUpperCase() + player2_name.slice(1)}`;
const check = ()=>{
    ...
    if (plyr_Ans == proper_answer) {
        if (answer_turn == "player1") {
            player1_score++;
            document.getElementById("spanP1Score").innerText = player1_score.toLocaleString("en-US").toString();
        } else {
            player2_score++;
            document.getElementById("spanP2Score").innerText = player2_score.toLocaleString("en-US").toString();
        }
    }
    if (question_turn == "player1") {
        question_turn = "player2";
        document.getElementById("player_question").innerText = "Question Turn - " + player2_name.toLowerCase().charAt(0).toUpperCase() + player2_name.slice(1);
    } else {
    ...
    if (answer_turn == "player1") {
        answer_turn = "player2";
        plyr_AnsInput.innerText = `Answer Turn - ${player2_name.toLowerCase().charAt(0).toUpperCase() + player2_name.slice(1)}`;
    } else {
        answer_turn = "player1";
        plyr_AnsInput.innerText = `Answer Turn - ${player1_name.toLowerCase().charAt(0).toUpperCase() + player1_name.slice(1)}`;
    }
...
},{}]},["45rJe","9gSo8"], "9gSo8", "parcelRequire790a")

//# sourceMappingURL=game.d00e456f.js.map
